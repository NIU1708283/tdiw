<?php
// Ocultar el sidebar en las páginas "Inici" (home), "Cistella" (cart), "Perfil" y "Contacte"
$action = $_GET['action'] ?? '';
// Hide on home page (including empty action, 'home', 'inicio'), cart pages, profile and contact
if (!in_array($action, ['', 'home', 'inicio', 'cistella', 'cart', 'perfil', 'contacte', 'historial-comandes', 'historialcomandes'])):
?>
