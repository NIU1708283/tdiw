...
// Gestiona tot el carret: afegir, eliminar, modificar i finalitzar compra
...
class CartController
{
    ...
    public function afegir() {
        ...
        if ($id > 0) {
            ...
            // Si l'usuari està registrat, guardar a la BD
            // Comentado para evitar lentitud - se guarda al cerrar sesión
            // if (isset($_SESSION['usuari']) && isset($_SESSION['usuari']['id'])) {
    ...
    public function buidar() {
        ...
        // Si l'usuari està registrat, esborrar de la BD
        // Comentado para evitar lentitud
        // if (isset($_SESSION['usuari']) && isset($_SESSION['usuari']['id'])) {
        //     esborrar_cabas_usuari((int)$_SESSION['usuari']['id']);
        // }
