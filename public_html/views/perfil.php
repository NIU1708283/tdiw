...
<body>
    ...
    <main>
        ...
        <section class="perfil-section">
            <legend>El meu historial de comandes</legend>
                    ...
                    <tbody>
                        <?php foreach ($llistatComandes as $c): ?>
                            <tr>
                                ...
                                <td><?= number_format((float)$c['import_total'], 2) ?>€</td>
                                <td>
                                    <a href="index.php?action=detall-comanda&id=<?= $c['id'] ?>" class="btn-detall">Veure Detall</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
